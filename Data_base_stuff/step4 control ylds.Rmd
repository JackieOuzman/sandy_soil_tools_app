...
mean_gains_values_no_amendment_Rip <- mean_gains_values_no_amendment_Rip[1,2]

mean_gains_values_no_amendment_spade <- mean_gains_values_no_amendment %>% 
  dplyr::filter(soil_modification == "Spade")
mean_gains_values_no_amendment_spade <- mean_gains_values_no_amendment_spade[1,2]
