  ...
  mutate(amendment = 
       ...
       ifelse(site                   == "Ouyen_Placement"
         ...
         ifelse(site                   == "Ouyen_Placement"
          ...
          ifelse(site                   == "Ouyen_Placement"
                & amendment_organic         == "none"   #this is the ouyen placement - GSP was applied annually at depth but with fert
                & amendment_fert            == "Fert.banded 30 cm"
                & amendment_other           == "other",
                paste0("Fert.banded_30" ) ,
...
primary_join_2 <- primary_join_2 %>%
  ...
  filter(ID  != "Bute_CSIRO_2018_plot_B1_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2018	B1	Demo") %>%
  filter(ID  != "Bute_CSIRO_2018_plot_B10_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2018	B10	0") %>%
  filter(ID  != "Bute_CSIRO_2018_plot_B5_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2018	B5	0") %>%
  filter(ID  != "Bute_CSIRO_2018_plot_B6_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2018	B6	0") %>%
  filter(ID  != "Bute_CSIRO_2018_plot_B9_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2018	B9	0") %>%
  filter(ID  != "Bute_CSIRO_2018_plot_B-1_rep_block_Demo") %>%
  
  filter(ID  != "Bute_CSIRO	2019	B0	Demo") %>%
  filter(ID  != "Bute_CSIRO	2019	B4	Demo") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B-1_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B1_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B0_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B4 _rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B5_rep_block_1") %>% 
  filter(ID  != "Bute_CSIRO_2019_plot_B10_rep_block_4") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B6_rep_block_2") %>%
  filter(ID  != "Bute_CSIRO_2019_plot_B9_rep_block_3") %>%
  
  
  filter(ID  != "Bute_CSIRO_2020_plot_B11_rep_block_Buffers") %>%
  filter(ID  != "Bute_CSIRO	2020	B11	Buffers") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B12_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B12	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B13_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B13	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B14_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B14	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B15_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B15	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B16_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B16	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B17_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B17	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B18_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B18	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B19_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B19	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B2_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2020	B2	0") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B20_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B20	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B21_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO	2020	B21	Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B3_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2020	B3	0") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B7_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2020	B7	0") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B8_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2020	B8	0") %>%
  filter(ID  != "Bute_CSIRO_2020_plot__rep_block_0") %>%
  filter(ID  != "Bute_CSIRO	2020	NA	0") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B-1_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B0_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B1_rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B4 _rep_block_Demo") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B10_rep_block_4") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B5_rep_block_1") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B6_rep_block_2") %>%
  filter(ID  != "Bute_CSIRO_2020_plot_B9_rep_block_3") %>% 
  
  filter(ID  != "Bute_CSIRO_2021_plot_B-1_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B0_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B1_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B10_rep_block_4") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B11_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B12_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B13_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B14_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B15_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B16_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B17_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B18_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B19_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B2_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B20_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B21_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B3_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B4 _rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B5_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B6_rep_block_2") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B7_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B8_rep_block_0") %>%
  filter(ID  != "Bute_CSIRO_2021_plot_B9_rep_block_3"
      )
