...
*sandy soil dataset* (linear model)
...
*I can't get this package to load - can't work this out doesn seem to have dependecies.*
...
```{r ANOVA Welch unequal variances example, echo=FALSE}
...
anova_sand_graph <- aov(yield ~ Descriptors, data = summary_data_site)

tukey <- (HSD.test(anova_sand_graph, "Descriptors"))
print(tukey)


tukey.cld <- multcompLetters4(anova_sand_graph, tukey) # default is threshold = 0.05
print(tukey.cld)
