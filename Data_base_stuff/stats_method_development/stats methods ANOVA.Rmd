...
Analysis of Variance (ANOVA) was undertaken using the GENSTAT version 13 statistical package (VSN International, Rothamsted, UK). 

Assumptions of constant error variance (homogeneity), normality of data
distribution and additivity of treatment and replicate effects were tested for each analysis. 

Least significant difference (l.s.d.) between treatments was determined at <5 % significance using Fisher’s protected l.s.d.
