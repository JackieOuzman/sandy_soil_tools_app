...
A_start <- summary_data_site
A_start <- as.data.frame(ungroup(A_start))
summary_data_site <- A_start
...
data_summary_all_analysis_name <- paste0(site_name,"_", year, "_ANOVA_Hoc")
...
assign(data_summary_all_analysis_name,data_summary_all_analysis) #this is supposed to write df as object not working?
#return(data_summary_all_analysis)
}

#######################################################################################################################################################
### Run function
test <- function_anova("Carwarp_Amelioration", 2018)
#######################################################################################################################################################
View(test)
