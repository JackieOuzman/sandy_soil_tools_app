...
tabPanel("What is my constraint", #tab title pageleafletOutput("map"),
         fluidPage( 
           fluidRow(
             box(
               ...
               tags$img(src = "water drop.jpg",height = 185), #need to resize this image
             ...
             box(
               ...
               tags$br(), #this is a break
               tags$img(src = "pH_chart.jpg", height = 185), #wrong size
               tags$br(), #this is a break
               tags$a(href="13 July 2022 - Water Repellence and pH in Sandy Soils.pdf", ## this documnet need to sit inside the app directory in a folder called www
         ...
         fluidRow(
           h2(HTML("Sites with same constraints</b>"), 
            ...
            hr(),
           fluidRow(DT::dataTableOutput("select_constraints")
